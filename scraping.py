...
def mars_facts():
    ...
    # Used for some logic https://getbootstrap.com/docs/3.4/css/#tables
    return df.to_html(classes="table-condensed")# remove classes="table table-striped" and replaced with classes= "table-condensed"
